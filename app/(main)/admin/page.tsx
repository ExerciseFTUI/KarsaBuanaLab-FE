        ...
        <div className="grid gap-4 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3 ">
          <Card>
            ...
            <CardContent className="flex justify-between items-center">
              ...
              <Link href="/marketing" className="ml-auto">
                <Button variant={"outline"} className="mt-4">
                  <p className="hidden mr-1 text-xs max-md:block 2xl:block">
                    View Page
                  </p>
          ...
          <Card>
            ...
            <CardContent className="flex justify-between items-center">
              ...
              <Link href={"sampling"} className="ml-auto">
                <Button variant={"outline"} className="mt-4">
                  <p className="hidden text-xs mr-1 max-md:block 2xl:block">
                    View Page
                  </p>
                  <ChevronRightIcon className="h-4 w-4" />
                </Button>
          ...
          <Card>
            ...
            <CardContent className="flex justify-between items-center">
              ...
              <Link href={"pplhp"} className="ml-auto">
                <Button variant={"outline"} className="mt-4">
                  <p className="hidden text-xs mr-1 max-md:block 2xl:block">
                    View Page
                  </p>
          ...
          <Card>
            ...
            <CardContent className="flex justify-between items-center">
              ...
              <Link href={"/lab"} className="ml-auto">
                <Button variant={"outline"} className="mt-4">
                  <p className="hidden text-xs mr-1 max-md:block 2xl:block">
                    View Page
                  </p>

    ...
    return (
        <div className="w-1/2 h-screen px-16 space-y-6">
            <div className="flex flex-row text-2xl font-medium space-x-0 cursor-pointer">
                <div className="flex flex-col items-end text-moss_green w-1/2">
                    <h1 className="m-4 mx-5">Sampel</h1>
                    <div className="w-4/5 h-1 bg-moss_green rounded-l-full" />
                </div>
                <div
                    className="text-ghost_green w-1/2 cursor-pointer"
                    onClick={() => router.push("doc/")}
                >
                    <h1 className="m-4 mx-5">Dokumen</h1>
                    <div className="w-4/5 h-1 bg-ghost_green rounded-r-full" />
                </div>
            </div>

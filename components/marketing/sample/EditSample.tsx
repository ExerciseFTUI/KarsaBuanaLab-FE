...
const EditSample: FC<EditSampleType> = ({ sample, regulation }) => {
  ...
  // Retrieve the name of the selected regulation based on the regulation number
  ...
  // Update the selected regulation name when the regulation changes
  React.useEffect(() => {
    setSelectedRegulationName(findRegulationName());
  }, [regulation, sample]);

  // Log user input data when the Confirm button is clicked
  const handleConfirmClick = () => {
    console.log('User Input Data:', { Sample: sample, Regulation: selectedRegulationName });
  };
      ...
      {sample !== "" && (
        <div>
          ...
          <div className='h-fit'>
            ...
            <Input type="" className='py-5' placeholder={sample} onChange={(value) => console.log('User Input in Sample:', value)} />
          </div>
          {/* End of Edit Sample */}
          ...
          {regulation !== 0 && (
            <div>
              ...
              <div className='h-fit mt-10'>
                ...
                <Input type="" className='py-5' placeholder={selectedRegulationName || "Select a regulation"} onChange={(value) => console.log('User Input in Regulation:', value)} />
              </div>
              ...
              <div className='h-fit mt-10'>
                ...
                <div className='flex justify-center'>
                  <EditParameter regulation={regulation} selectedRegulationName={selectedRegulationName} />
                </div>
              </div>
              ...
              <div className="flex w-full flex-row justify-evenly mt-10">
                ...
                <button onClick={handleConfirmClick} className="bg-light_green text-white hover:bg-dark_green border-2 rounded-md p-3 border-slate-300 text-base font-medium">Confirm</button>  
              </div>
